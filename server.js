...
app.use(cors({
  origin: [
    ...
    'https://raansley-cmd.github.io/SkylarsPlantBasedCooking',
    'http://localhost',
    'http://127.0.0.1'
  ]
}));
...
app.post('/create-checkout-session', async function(req, res) {
  try {
    ...
    var session = await stripe.checkout.sessions.create({
      ...
      success_url: 'https://raansley-cmd.github.io/SkylarsPlantBasedCooking/success.html?session_id={CHECKOUT_SESSION_ID}',
      cancel_url:  'https://raansley-cmd.github.io/SkylarsPlantBasedCooking/index.html'
    });
